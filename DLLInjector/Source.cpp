...
DWORD Inject(HANDLE hProc, HANDLE hThread, ULONG_PTR pRemoteLoadLibrary) {
	UCHAR shellCode[]{
		...
		/*0x10  */ 0x48, 0x83, 0xEC, 0x28, // fix stack alignment
		/*0x14  */ 0x48, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rcx, string pointer
		/*0x1e: */ 0x90, 0x90, // nop alignment
		/*0x20: */ 0xFF, 0x15, 0xDA, 0xFF, 0xFF, 0xFF, // call LoadLibraryW
		/*0x26: */ 0x48, 0x83, 0xC4, 0x28,
		/*0x2a: */ 0xF7, 0xD8,                         // neg eax
		/*0x2c: */ 0x1B, 0xC0,                         // sbb eax, eax
		/*0x2e: */ 0xF7, 0xD8,                         // neg eax
		/*0x30: */ 0x48,                               // dec eax
		/*0x31: */ 0xC3,                               // ret
		...
		/*0x32: */ 
	};
	...
	ULONG_PTR strOffset = shellBase + 0x32;

	memcpy(shellCode, &pRemoteLoadLibrary, sizeof(ULONG_PTR));
	memcpy(shellCode + 0x16, &strOffset, sizeof(ULONG_PTR));
